...
namespace MHN_TPmoyennes            //MHN = Minh Hoang NGUYEN
{
    ...
    public class Matiere
    {
        ...
        public override string ToString() // Remplacez la méthode ToString pour renvoyer le nom de l’objet
        {
            return Nom;
        }
    }
    ...
    {
        public static double Truncate2decimale(double moyenne)     //Tronquage les moyennes à 2 chiffres après la virgule
        {
